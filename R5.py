...
# Create a random graph with 100 nodes and average connectivity of 4
...
# Print the new value of the average distance
print(f"New Average Distance Traveled per Day with Connectivity 4: {average_distance_per_day:.2f} edges")
